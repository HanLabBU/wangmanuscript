function dual_sensor_vm_ssnadp_trace()
    ...
    for file_idx=1:length(file_list)
        ...
        for trial_idx=1:numel(result.vm_trial)
            ...
            current_category_1 = result.vm_trial(trial_idx).event_category.is_ssnadp;
            current_idx_list = result.vm_trial(trial_idx).event.idx(current_category_1==1);
    ...
    title({'SS w/o ADP triggered Vm',['N=',num2str(size(plot_data,2)),' Neurons']},'Interpreter','none')
    ...
    title({'SS w/o ADP triggered GCaMP',['N=',num2str(size(plot_data,2)),' Neurons'],['One-sample t-test p=',num2str(p)]},'Interpreter','none')     
    ...
    title({'SS w/o ADP',['N=',num2str(size(plot_data,2)),' Neurons'],['R square = ',num2str(fit_result.Rsquared.Ordinary)]},'Interpreter','none') 
